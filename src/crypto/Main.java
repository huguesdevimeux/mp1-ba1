...
public class Main {
	...
	public static void main(String args[]) {
		...
		case 1:
			...
			// random will be the user's input and will be the message decoded
			
			//printing the ciphered version chosing the algorithm chosen by the user
			...
			//Because we are using brute force for XOR, you will need to manually look for the decrypted message
